...
-- 파이썬, C#등 프로그래밍언어로 가져갈 땐, 컬럼이름 컬럼갯수를 모두 파악해야 하기때문에 아래와 같이 사용
SELECT bookid, bookname, publisher, price
	FROM Book;
    
-- 3-3 : 도서 테이블의 모든 출판사를 검색하시오.
-- 출판사별로 한번만 출력하면 좋겠음
-- ALL - 전부다, DISTINT - 중복 제거하고 하나만 
SELECT DISTINCT publisher
	FROM Book;
    
-- 3-4 : 도서 중 가격이 20000원 미만 인것을 계산하시오
...
-- 		_구% : 첫번째 글자는 뭐든지 상고나없고, 두번째 글자가 구로되고 뒤에 글이 더있다
SELECT *
	FROM Book
...
-- 3-14 : 도서를 가격의 내림차순으로 검색하시오. 가격이 같다면 출판사르 오름차순으로 출력하시오.
SELECT *
	FROM Book
