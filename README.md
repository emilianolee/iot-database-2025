...
- SQL 기초
    ...
    - DML 중 INSERT, UPDATE, DELETE : [SQL](./day03/db02_dml_쿼리.sql)
        ...
        VALUES (값리스트); -- VALUE는 SQL표준이 아님(MySQL, )
...
- 데이터베이스 프로그래밍
    ...
    - 저장 프로시저 계속 
        ...
        - 커서 사용 프로시저 : [SQL](./day05/db01_저장프로시저4.sql)
...
- Workbench Tip
    ...
    - 메뉴 `Edit > Preferences > SQL Editors > SQL Execution 에서 Limit Rows Count`를 조절
...
- tkinter DB연동 GUI앱 개발[Python](./day09/students_regapp.py)
    ...
    2. madang DB에 students테이블 생성
        ```sql
        drop table if exists students; -- 현재 테이블 삭제
        create table students(
            std_id integer primary key auto_increment, -- auto increment는 MySQL 옵션,
