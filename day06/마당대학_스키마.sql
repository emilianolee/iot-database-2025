...
-- -----------------------------------------------------
-- Table `madanguniv`.`Depth`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `madanguniv`.`Depth` (
  `dno` INT NOT NULL,
  `dname` VARCHAR(45) NOT NULL,
  `office` VARCHAR(45) NULL,
  `runprofessorssn` INT NOT NULL,
  PRIMARY KEY (`dno`),
  INDEX `fk_Depth_Professor_idx` (`runprofessorssn` ASC) VISIBLE,
  CONSTRAINT `fk_Depth_Professor`
...
CREATE TABLE IF NOT EXISTS `madanguniv`.`Graduate` (
  ...
  PRIMARY KEY (`ssn`),
  INDEX `fk_Graduate_Depth1_idx` (`dno` ASC) VISIBLE,
  INDEX `fk_Graduate_Graduate1_idx` (`graduatessn` ASC) VISIBLE,
  CONSTRAINT `fk_Graduate_Depth1`
    FOREIGN KEY (`dno`)
    REFERENCES `madanguniv`.`Depth` (`dno`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `madanguniv`.`work_dept` (
  ...
  INDEX `fk_work_dept_Depth1_idx` (`dno` ASC) VISIBLE,
  CONSTRAINT `fk_work_dept_Professor1`
    FOREIGN KEY (`professorssn`)
    REFERENCES `madanguniv`.`Professor` (`ssn`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_work_dept_Depth1`
    FOREIGN KEY (`dno`)
    REFERENCES `madanguniv`.`Depth` (`dno`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
