...
from tkinter.font import *  # 기본의 폰트를 사용하러면
...
def modData():
    ...
    if std_id == '':
        messagebox.showwarning('UPDATE', '수정할 데이터 선택 요망!')
        return
...
def delData():
    ...
    if std_id == '':
        messagebox.showwarning('DELETE', '삭제할 데이터 선택 요망!')
        return
...
root.geometry('820x500')    # 윈도우 크기 설정
